    ...
    public static void main(String[] args) {
        ...
        if (choice.equals("voiture")){
            ...
            for(int I = 0; I<i ; I++) {
                ...
                System.out.println("Choissisez un nouveaux nom :");
                String UserProductName = sc.next();
                acces[i] = UserProductName;
                System.out.println("Choissisez un nouveaux Prix :");
                double UserProductPrice = sc.nextDouble();
                accesprix[i] = UserProductPrice;
            }
        System.out.println("Résuletat de vos atributions :");
        for(int i=0; i<5; i++) {
            System.out.println(accesprix[i] + "  ------->  " + acces[i]);
            }
        }
        else {
